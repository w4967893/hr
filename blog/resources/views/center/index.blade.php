...
@section('content')
    <div class="page-content">
        ...
        <div class="row margin-top-10">
            ...
            <div class="portlet light">
                ...
                <form class="form-inline" role="form" action="/center/index" method="get">
                    <div class="form-group">
                        <label class="sr-only" for="exampleInputEmail2">Email address</label>
                        <input type="text" class="form-control" id="" name="name" placeholder="中心名称">
                    </div>
                    {{--<div class="form-group">--}}
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="float:right">
                            {!! $centerList->appends(array('name'=>$name))->render() !!}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/center/index.js') }}" type="text/javascript"></script>
@endsection
